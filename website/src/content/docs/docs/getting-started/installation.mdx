...
[releases page](https://github.com/bitknox/anistream/releases). Download the archive for your
platform, unpack it, and put `anistream` on your `PATH`. Each archive ships with a `.sha256` worth
...
muxing subtitles into a completed download, so install those first — see Prerequisites below.
